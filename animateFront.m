...
for ii = 0:Nframes
    ...
    We(elTypes==1,:) = res.resElem.W_T_elem(elTypes==1);
    We(elTypes==2,:) = res.resElem.W_U_elem(elTypes==2);
    We(elTypes==3,:) = ( res.resElem.W_T_elem(elTypes==3) + res.resElem.W_U_elem(elTypes==3) )/2;
